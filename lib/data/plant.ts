export const plants: Plant[] = [
  ...
  },
  {
    id: 234,
    japanese_name: "ラッキョウ",
    scientific_name: "Allium chinense",
    family_id: 38,
    genus: "ネギ属",
    description: [
    ...
    tags: ["夏開花", "草本", "雑草"],
    flower_colors: ["白", "ピンク", "紫"],
    similar_plant_ids: [235],
  },
  {
    id: 235,
    japanese_name: "ヤマラッキョウ",
    scientific_name: "Allium thunbergii",
    family_id: 38,
    genus: "ネギ属",
    description: [
      "山地の草原や岩場に生える多年草で、秋に赤紫色の小花を球状に咲かせる。",
      "ラッキョウに似るがより野生的で、花色が濃く、花期も秋にずれる。",
      "細い葉とすっきりした草姿で、秋の山野草として人気がある。",
    ],
    identification: [
      "秋に赤紫色の小花が球状にまとまって咲く",
      "葉は細い円筒形で、株元から多数出る",
    ...
    tags: ["秋開花", "草本", "山"],
    flower_colors: ["ピンク", "赤", "紫"],
    similar_plant_ids: [234],
  },
  {
    id: 236,
    japanese_name: "ニッコウキスゲ",
    scientific_name: "Hemerocallis middendorffii",
    family_id: 68,
    genus: "ワスレグサ属",
    description: [
      "高原や湿原を代表する多年草で、初夏に鮮やかな黄色の大きな花を咲かせる。",
      "朝に開いた花は夕方にはしぼむ一日花で、群生地では草原一面が黄色く見える。",
      "日光や霧ヶ峰、尾瀬などの高原景観を象徴する植物として親しまれる。",
    ],
    identification: [
      "鮮やかな黄色の漏斗形の花を上向きに咲かせる",
      "細長い葉が根元から弓なりに束生する",
      "花は一日でしぼむが、次々に咲き続ける",
      "高原・湿原・草原の群生地でよく見られる",
    ],
  ...
  },
  {
    ...
    distribution: "北海道〜九州の山野・林縁",
    image_url:
      "https://commons.wikimedia.org/wiki/Special:FilePath/%E3%83%A4%E3%83%9E%E3%83%8F%E3%82%AE_Lespedeza_bicolor.JPG",
    local_image_url: "/images/plants/238-1.webp",
    images: [
      {
        url: "https://commons.wikimedia.org/wiki/Special:FilePath/%E3%83%A4%E3%83%9E%E3%83%8F%E3%82%AE_Lespedeza_bicolor.JPG",
        local_url: "/images/plants/238-1.webp",
        caption: "全体",
      },
      {
        url: "https://commons.wikimedia.org/wiki/Special:FilePath/%E3%83%A4%E3%83%9E%E3%83%8F%E3%82%AE%28%E5%B1%B1%E8%90%A9%29%28Lespedeza_bicolor%29-%E8%8A%B1_%286180060175%29.jpg",
        local_url: "/images/plants/238-2.webp",
        caption: "花",
      },
    ],
    tags: ["秋開花", "落葉", "低木", "山"],
    flower_colors: ["ピンク", "赤", "紫"],
    similar_plant_ids: [239, 241],
  },
  {
    id: 239,
    japanese_name: "キハギ",
    scientific_name: "Lespedeza buergeri",
    family_id: 10,
    genus: "ハギ属",
    description: [
      "丘陵地から低山の明るい林縁や岩場に生える落葉低木で、ハギ類の中でも木質化が強い。",
      "花は淡い黄白色を帯び、旗弁や翼弁に赤紫色の筋や色が入るのが特徴。",
      "夏から秋まで長く咲き、やや乾いた場所にもよく適応する。",
    ],
    identification: [
      "花は黄白色を基調に、赤紫色の筋や翼弁の色が混じる",
      "枝は木質化が強く、株は直立気味に育つ",
      "葉は3小葉からなる複葉で、小葉はやや厚く先が尖る",
      "明るい林縁や尾根筋の岩場などに生える",
    ],
    distribution: "本州〜九州の丘陵地・山地林縁",
    image_url:
      "https://commons.wikimedia.org/wiki/Special:FilePath/%E3%82%AD%E3%83%8F%E3%82%AE%28Lespedeza_buergeri%29.jpg",
    images: [
      {
        url: "https://commons.wikimedia.org/wiki/Special:FilePath/%E3%82%AD%E3%83%8F%E3%82%AE%28Lespedeza_buergeri%29.jpg",
        caption: "花",
      },
    ],
    tags: ["夏開花", "秋開花", "落葉", "低木", "山"],
    flower_colors: ["白", "黄", "ピンク", "紫"],
    similar_plant_ids: [238, 241],
  },
  {
    id: 240,
    japanese_name: "メドハギ",
    ...
    distribution: "本州〜九州の草地・道端",
    image_url:
      "https://commons.wikimedia.org/wiki/Special:FilePath/%EB%B9%84%EC%88%98%EB%A6%AC.JPG",
    local_image_url: "/images/plants/240-1.webp",
    images: [
      {
        url: "https://commons.wikimedia.org/wiki/Special:FilePath/%EB%B9%84%EC%88%98%EB%A6%AC.JPG",
        local_url: "/images/plants/240-1.webp",
        caption: "花",
      },
    ],
    tags: ["夏開花", "秋開花", "草本", "山", "雑草"],
    flower_colors: ["白", "黄"],
    similar_plant_ids: [],
  },
  {
    id: 241,
    japanese_name: "マルバハギ",
    scientific_name: "Lespedeza cyrtobotrya",
    family_id: 10,
    genus: "ハギ属",
    description: [
      "山地の明るい林縁や草地に生える落葉低木で、丸みのある小葉と紅紫色の花が目立つ。",
      "秋の七草のハギ類に近く、ヤマハギより葉に幅があり、こんもりとした樹形になりやすい。",
      "庭木として植えられることもあり、秋の景色を彩る。",
    ],
    identification: [
      "3小葉からなる複葉で、小葉は丸みのある楕円形",
      "紅紫色の蝶形花が枝先近くにまとまって咲く",
      "枝は低くよく分枝し、株全体がこんもりする",
      "山地の草地や林縁、土手に生える",
    ],
    distribution: "本州〜九州の山地草地・林縁",
    image_url:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Lespedeza_cyrtobotrya_02.JPG/1280px-Lespedeza_cyrtobotrya_02.JPG",
    local_image_url: "/images/plants/241-1.webp",
    images: [
      {
        url: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Lespedeza_cyrtobotrya_02.JPG/1280px-Lespedeza_cyrtobotrya_02.JPG",
        local_url: "/images/plants/241-1.webp",
        caption: "花",
      },
    ],
    tags: ["夏開花", "秋開花", "落葉", "低木", "山"],
    flower_colors: ["ピンク", "赤", "紫"],
    similar_plant_ids: [238, 239],
  },
  {
    id: 242,
    japanese_name: "キリ",
    ...
    genus: "キリ属",
    description: [
      "大きな葉と春の紫色の花で知られる落葉高木。成長が早く、古くから良材として利用される。",
      "材は軽く狂いが少ないため、箪笥や下駄、楽器などに使われてきた。",
      "初夏には大きな葉がよく茂り、冬には卵形の果実が残ることがある。",
    ],
    identification: [
      "春に紫色の筒状花が大きな円錐花序になって咲く",
      "葉は非常に大きく、広いハート形でやわらかい",
      "樹皮は灰褐色で比較的なめらか",
      "果実は卵形の蒴果で冬まで残ることが多い",
    ],
    distribution: "本州〜九州（植栽・半野生）",
    image_url:
      "https://commons.wikimedia.org/wiki/Special:FilePath/Paulownia_tomentosa_(5).JPG",
    local_image_url: "/images/plants/242-1.webp",
    images: [
      {
        url: "https://commons.wikimedia.org/wiki/Special:FilePath/Paulownia_tomentosa_(5).JPG",
        local_url: "/images/plants/242-1.webp",
        caption: "花",
      },
    ],
    tags: ["春開花", "落葉", "高木", "公園"],
  ...
  },
  {
    id: 243,
    japanese_name: "アオギリ",
    scientific_name: "Firmiana simplex",
    family_id: 66,
    genus: "アオギリ属",
    description: [
      "大きな手のひら形の葉をつける落葉高木で、公園木や街路樹として植えられる。",
      "幹はまっすぐ伸び、樹皮が緑色を帯びる若木も多い。",
      "夏に小さな花を円錐状に多数つけ、秋には舟形の果実が赤く色づく。",
    ],
    identification: [
      "葉は大きな掌状で3〜5浅裂することが多い",
      "葉柄が長く、枝先に大きな葉を広げる",
      "夏に小花を円錐花序につける",
      "果実は裂けた舟形になり、中の種が目立つ",
    ],
    distribution: "本州〜沖縄（植栽）",
    image_url:
      "https://commons.wikimedia.org/wiki/Special:FilePath/Firmiana_simplex_(1).jpg",
    local_image_url: "/images/plants/243-1.webp",
    images: [
      {
        url: "https://commons.wikimedia.org/wiki/Special:FilePath/Firmiana_simplex_(1).jpg",
        local_url: "/images/plants/243-1.webp",
        caption: "全体",
      },
    ],
    tags: ["夏開花", "落葉", "手のひら葉", "高木", "街路樹", "公園"],
    flower_colors: ["黄"],
    similar_plant_ids: [],
  },
  {
    ...
    genus: "キク属",
    description: [
      "秋を代表する園芸植物で、多彩な花色と花形をもつ。古くから観賞用として盛んに栽培される。",
      "頭状花序をつけ、外側の舌状花と中心の筒状花が集まって一つの花のように見える。",
      "観賞菊、食用菊、仏花など用途も幅広い。",
    ],
    identification: [
      "花は頭状花序で、舌状花が多数並ぶ品種が多い",
      "葉は互生し、深い切れ込みと独特の香りがある",
      "秋に大輪から小輪まで多様な花を咲かせる",
      "主に庭や公園、鉢植えで栽培される",
    ],
    distribution: "全国（栽培）",
    image_url:
      "https://commons.wikimedia.org/wiki/Special:FilePath/Chrysanthemum_morifolium_(1).jpg",
    local_image_url: "/images/plants/244-1.webp",
    images: [
      {
        url: "https://commons.wikimedia.org/wiki/Special:FilePath/Chrysanthemum_morifolium_(1).jpg",
        local_url: "/images/plants/244-1.webp",
        caption: "花",
      },
    ],
    tags: ["秋開花", "草本", "小花集合", "公園"],
    flower_colors: ["白", "黄", "ピンク", "赤", "紫", "橙"],
    similar_plant_ids: [],
  },
  {
    id: 245,
    ...
    genus: "ボタン属",
    description: [
      "春から初夏にかけて大きく豪華な花を咲かせる落葉低木で、「百花の王」とも呼ばれる。",
      "中国原産の園芸植物として古くから親しまれ、日本でも寺院や庭園でよく栽培される。",
      "シャクヤクに似るが、木質の枝が残る点で区別できる。",
    ],
    identification: [
      "大きく重なった花弁をもつ豪華な花を咲かせる",
      "枝は木質化して冬も地上部が残る",
      "葉は大きく切れ込み、やや青みを帯びることがある",
      "春の庭園や公園で観賞用に植えられる",
    ],
    distribution: "全国（栽培）",
    image_url:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/PAEONIA_SUFFRUTICOSA_%2810%29.jpg/1280px-PAEONIA_SUFFRUTICOSA_%2810%29.jpg",
    local_image_url: "/images/plants/245-1.webp",
    images: [
      {
        url: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/PAEONIA_SUFFRUTICOSA_%2810%29.jpg/1280px-PAEONIA_SUFFRUTICOSA_%2810%29.jpg",
        local_url: "/images/plants/245-1.webp",
        caption: "花",
      },
    ],
    tags: ["春開花", "落葉", "低木", "公園"],
