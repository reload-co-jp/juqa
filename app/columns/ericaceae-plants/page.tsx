  ...
  return (
    <div style={{ maxWidth: "48rem", margin: "0 auto", color: "#e0e0e0" }}>
      ...
      <Section title="ツツジ属の代表たち — ヤマツツジ・ミツバツツジ・サツキ">
        ...
        <PlantCard plantId={209} points={[ "日本で最も広く自生するツツジ（4〜6月開花）",
            "朱赤色〜橙赤色の漏斗形の花を咲かせる",
            "葉は2型（大きい春葉と越冬する小さい秋葉）をもつ半常緑性",
            "おしべは5本（ミツバツツジの10本と区別できる）", ]} tip="野山で朱赤色のツツジを見かけたらまずヤマツツジを疑いましょう。おしべが5本なのも識別のポイントです。" />
        <PlantCard plantId={199} points={[ "花が咲いてから葉が展開する（春、4〜5月）",
            "枝先に3枚の葉が輪生状に集まるのが名前の由来",
            "淡紫紅色の花を咲かせ、おしべは10本",
            "山地の明るい林縁や尾根によく生える", ]} tip="葉より先に紫がかったピンクの花が咲き、枝先に3枚葉が集まっていればミツバツツジです。" />
        <PlantCard plantId={153} points={[ "5〜6月に開花し、ツツジより約1ヶ月遅い（「皐月＝5月」が名の由来）",
            "葉は小さく硬くて光沢があり、縁に細かい毛が生える",
            "自然では渓谷沿いの岩場に生える半常緑低木",
            "公園の刈込み生垣として全国で広く植えられている", ]} tip="ツツジとサツキは似ていますが、開花時期で区別できます。ゴールデンウィーク頃が満開ならツツジ、梅雨前後ならサツキです。" />
        <PlantCard plantId={200} points={[ "5〜6月に橙赤色の大きな花を咲かせる",
            "高原・草原・山地の明るい場所に群生する",
            "葉・茎・花にグラヤノトキシンという毒素を含む（牛馬は食べない）",
            "霧ヶ峰・尾瀬・蔵王など高原の景観植物として有名", ]} tip="高原で橙赤色の大きなツツジが群生していたらレンゲツツジです。美しいですが、毒があるので口にしないようにしましょう。" />
      </Section>
